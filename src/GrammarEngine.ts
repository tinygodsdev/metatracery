...
import { ParameterExtractor, ExtractedParameters } from './ParameterExtractor';
...
export class GrammarEngine {
  ...
  generateAllCombinations(
    ...
    // Apply constraints
    if (constraints) {
      parameters = this.parameterExtractor.filterParameters(parameters, {
        required: constraints.requiredParameters,
        excluded: constraints.excludedParameters
      });
    }
  ...
  generateParameterMatrix(
    rule: string,
    parameterSpace: ParameterMatrix
  ): GenerationResult[][] {
